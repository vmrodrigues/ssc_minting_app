...
export interface HomeProps {
  candyMachineImage: string;
  candyMachineName: string;
  candyMachineDesc: string;
  crossmintClient: string;
...
const MintingApp = (props: HomeProps) => {
  ...
  const candyImage = props.candyMachineImage;
  const candyName = props.candyMachineName;
  const crossmintClientID = props.crossmintClient;
  //const candyDesc = props.candyMachineDesc;
  ...
  return (
   ...
   <>
    <Container style={{ marginTop: 25 }}>
        ...
        >
          <h3 style={{fontFamily: "Source Sans 3"}}>
            {candyName}</h3>
          <SuperStarImage
            style={{ marginTop: 5 }}
            src={'/img/' + candyImage}
            alt="Candy Machine Image"
          ></SuperStarImage>
                      ...
                      {isPresale &&
                        ...
                        new Date().getTime() / 1000 && (
                          <Typography
                            ...
                            align="center"
                            display="block"
                            style={{ fontWeight: "bold",fontFamily: "Source Sans 3"
                          }}
                          >
                            UNTIL PUBLIC MINT
                          </Typography>
